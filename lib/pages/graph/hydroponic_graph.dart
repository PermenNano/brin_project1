...
class HydroponicGraph extends StatefulWidget {
  final String farmId;
  final String? sensorId;

  const HydroponicGraph({Key? key, required this.farmId, this.sensorId})
      : super(key: key);

  @override
  _HydroponicGraphState createState() => _HydroponicGraphState();
}

class _HydroponicGraphState extends State<HydroponicGraph> {
